 ...
 *@arg: a string generated from getline containing all arguements
 *@argv: an array of strings generated from arg
 *@path: a string path for the current command in place
...
/**
 *struct builtin - contains a builtin String and all related functions
